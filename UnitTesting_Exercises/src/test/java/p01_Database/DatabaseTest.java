...
public class DatabaseTest {
    ...
    public void testConstructorHasCreateValidObject(){
        ...
        Assert.assertArrayEquals("Arrays are not the same!", elements, NUMBERS);   //first way

        Assert.assertEquals("Count of elements is incorrect!", elements.length, NUMBERS.length);    //second way
